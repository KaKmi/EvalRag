...
> 状态（2026-07-18）：以下多数已由 **E-W2b 功能波交付**（分支 `ship/e-w2b-4-gold-docs-recall-ndcg-citation-timeoutms-plumb-abort`，PR 见 002 附录 A E-W2b 行）；仅问题池 / 加入评测集 / gold_stale 检测器仍 OUT。

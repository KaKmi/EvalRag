...
const detail: SessionDetailResponse = {
  ...
  agentName: "退款助手",
  rounds: [
    { traceId: "a".repeat(32), userInput: "怎么退款", output: "支持 7 天无理由[1]", status: "success", durationMs: 2410, startTime: "2026-07-13T09:11:00.000Z" },
    { traceId: "b".repeat(32), userInput: "多久到账", output: "很抱歉，暂时无法回答。", status: "fallback", durationMs: 1500, startTime: "2026-07-13T09:12:00.000Z" },
  ],
};
...
describe("SessionDetailPage (M9 W3)", () => {
  ...
  it("empty session shows not-found placeholder", async () => {
    mocked.getSession.mockResolvedValue({ sessionId: "x", userId: null, agentId: "", agentName: "", rounds: [] });
    renderAt("x");

...
it("列表按原型 §5 显示 gold docs 覆盖率与一位小数的上次得分", async () => {
  renderPage([evalSet(), evalSet({ id: "set-2", name: "高频 Badcase 集", kbIds: [], caseCount: 34, reviewedCaseCount: 0, goldDocCoverage: { withGoldDocs: 0, total: 34 }, lastRunScore: null })]);
